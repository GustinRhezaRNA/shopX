    ...
    if (typeof tinymce !== 'undefined') {
        tinymce.init({
            ...
            tinymceai_token_provider: async () => {
                await fetch(
                    `https://demo.api.tiny.cloud/1/zcpmrtj6pn0htsl1uclms4eltuc5lp10ac1didvxry6la2jq/auth/random`, {
                        method: "POST",
                        credentials: "include"
                    });
                return {
                    token: await fetch(
                        `https://demo.api.tiny.cloud/1/zcpmrtj6pn0htsl1uclms4eltuc5lp10ac1didvxry6la2jq/jwt/tinymceai`, {
                            credentials: "include"
                        }).then(r => r.text())
                };
            },
