...
@section('dashboard_contents')
    ...
    @include('frontend.dashboard.orders.index')
    @include('frontend.dashboard.track.index')
    @include('frontend.dashboard.address.index')
    @include('frontend.dashboard.wishlist.index')
